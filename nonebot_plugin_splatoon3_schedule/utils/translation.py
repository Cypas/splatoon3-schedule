...
def weapon_semantic_word_conversion(word: str):
    ...
    # 没有任何匹配时，取随机大类别
    # 遍历values
    father_class_list = [v for v in dict_weapon_weapon_father.values()]
    return word_type[4], random.choice(father_class_list)
...
dict_weapon_main_trans = {
    ...
    "Wellstring V": "邦普V",
    "Splash-o-matic GCK-O": "窄域标记枪GECK",
    "Colorz Aerospray": "专业模型枪 彩",
    "Glamorz Splattershot": "斯普拉射击枪 煌",
    "Splattershot Pro FRZ-N": "顶尖射击枪FRZN",
    "Clawz .96 Gal": ".96加仑 爪",
    "Jet Squelcher COB-R": "喷射清洁枪COBR",
    "Gleamz Blaster": "火热爆破枪 艳",
    "Rapid Blaster Pro WNT-R": "快速爆破枪 精英WNTR",
    "Glitterz L-3 Nozzlenose": "L3卷管枪 箔",
    "H-3 Nozzlenose VIP-R": "H3卷管枪SNAK",
    "Carbon Roller ANG-L": "碳纤维滚筒ANGL",
    "Starz Dynamo Roller": "电动马达滚筒 冥",
    "Planetz Big Swig Roller": "宽滚筒 惑",
    "Cometz Octobrush": "北斋 彗",
    "Painbrush BRN-Z": "文森BRNZ",
    "Splat Charger CAM-O": "斯普拉蓄力狙击枪FRST",
    "Splatterscope CAM-O": "斯普拉准星枪FRST",
    "Tri-Slosher ASH-N": "洗笔桶ASH",
    "Hornz Dread Wringer": "墨瀑淋 角",
    "Mini Splatling RTL-R": "斯普拉旋转枪PYTN",
    "Torrentz Hydra Splatling": "消防栓旋转枪 压",
    "Dapple Dualies NOC-T": "溅镀枪OWL",
    "Twinklez Splat Dualies": "斯普拉机动枪 耀",
    "Hoofz Dualie Squelchers": "双重清洁枪 蹄",
    "Tenta Brella CRE-M": "露营防空伞CREM",
    "Patternz Undercover Brella": "特工配件 缭",
    "Bulbz Tri-Stringer": "三发猎鱼弓 灯",
    "REEF-LUX 450 MIL-K": "LACT-450MILK",
    "Stickerz Splatana Stamper": "工作刮水刀 封",
    "Splatana Wiper RUS-T": "雨刷刮水刀RUST",
}

dict_weapon_weapon_father = {
    ".52 Gal": "短中射程",
    ".96 Gal": "中射程",
    ".96 Gal Deco": "中射程",
    "Aerospray MG": "短射程",
    "Aerospray RG": "短射程",
    "Annaki Splattershot Nova": "中射程",
    "Ballpoint Splatling": "超长射程",
    "Bamboozler 14 Mk I": "中长射程",
    "Big Swig Roller": "短中射程",
    "Big Swig Roller Express": "短中射程",
    "Blaster": "短中射程",
    "Bloblobber": "中射程",
    "Carbon Roller": "短射程",
    "Carbon Roller Deco": "短射程",
    "Clash Blaster": "短中射程",
    "Clash Blaster Neo": "短中射程",
    "Classic Squiffer": "中长射程",
    "Custom Dualie Squelchers": "中射程",
    "Custom Jet Squelcher": "长射程",
    "Custom Splattershot Jr.": "短射程",
    "Dapple Dualies": "短射程",
    "Dapple Dualies Nouveau": "短射程",
    "Dark Tetra Dualies": "短中射程",
    "Dualie Squelchers": "中射程",
    "Dynamo Roller": "中长射程",
    "E-liter 4K": "超长射程",
    "E-liter 4K Scope": "超长射程",
    "Explosher": "长射程",
    "Flingza Roller": "短中射程",
    "Forge Splattershot Pro": "中射程",
    "Glooga Dualies": "中射程",
    "Goo Tuber": "中长射程",
    "H-3 Nozzlenose": "中射程",
    "H-3 Nozzlenose D": "中射程",
    "Heavy Splatling": "中长射程",
    "Heavy Splatling Deco": "中长射程",
    "Hero Shot Replica": "短射程",
    "Hydra Splatling": "超长射程",
    "Inkbrush": "短射程",
    "Inkbrush Nouveau": "短射程",
    "Jet Squelcher": "长射程",
    "Krak-On Splat Roller": "短射程",
    "L-3 Nozzlenose": "短中射程",
    "L-3 Nozzlenose D": "短中射程",
    "Light Tetra Dualies": "短中射程",
    "Luna Blaster": "短射程",
    "Luna Blaster Neo": "短射程",
    "Mini Splatling": "中射程",
    "N-ZAP '85": "短射程",
    "N-ZAP '89": "短射程",
    "Nautilus 47": "中射程",
    "Neo Splash-o-matic": "短射程",
    "Neo Sploosh-o-matic": "短射程",
    "Octobrush": "短射程",
    "Painbrush": "短中射程",
    "Range Blaster": "中射程",
    "Rapid Blaster": "中长射程",
    "Rapid Blaster Deco": "中长射程",
    "Rapid Blaster Pro": "中长射程",
    "Rapid Blaster Pro Deco": "中长射程",
    "REEF-LUX 450": "短中射程",
    "S-BLAST '92": "中射程",
    "Slosher": "短中射程",
    "Slosher Deco": "短中射程",
    "Sloshing Machine": "中射程",
    "Snipewriter 5H": "超长射程",
    "Splash-o-matic": "短射程",
    "Splat Brella": "短射程",
    "Splat Charger": "超长射程",
    "Splat Dualies": "短射程",
    "Splat Roller": "短射程",
    "Splatana Stamper": "中射程",
    "Splatana Wiper": "短中射程",
    "Splatana Wiper Deco": "短中射程",
    "Splatterscope": "超长射程",
    "Splattershot": "短射程",
    "Splattershot Jr.": "短射程",
    "Splattershot Nova": "中射程",
    "Splattershot Pro": "中射程",
    "Sploosh-o-matic": "短射程",
    "Squeezer": "中长射程",
    "Tenta Brella": "中射程",
    "Tenta Sorella Brella": "中射程",
    "Tentatek Splattershot": "短射程",
    "Tri-Slosher": "短射程",
    "Tri-Slosher Nouveau": "短射程",
    "Tri-Stringer": "超长射程",
    "Undercover Brella": "短射程",
    "Z+F Splat Charger": "超长射程",
    "Z+F Splatterscope": "超长射程",
    "Zink Mini Splatling": "中射程",
    "Ballpoint Splatling Nouveau": "超长射程",
    "Bloblobber Deco": "中射程",
    "Custom Goo Tuber": "中长射程",
    "Dread Wringer": "中射程",
    "Gold Dynamo Roller": "中长射程",
    "Heavy Edit Splatling": "中射程",
    "Inkline Tri-Stringer": "超长射程",
    "Octobrush Nouveau": "短射程",
    "Sloshing Machine Neo": "中射程",
    "Sorella Brella": "短射程",
    "Custom Blaster": "短中射程",
    "Enperry Splat Dualies": "短射程",
    "Foil Squeezer": "中长射程",
    "Painbrush Nouveau": "短中射程",
    "REEF-LUX 450 Deco": "短中射程",
    "S-BLAST '91": "中射程",
    "Snipewriter 5B": "超长射程",
    "Undercover Sorella Brella": "短射程",
    "Splatana Stamper Nouveau": "中射程",
    ".52 Gal Deco": "短中射程",
    "Custom E-liter 4K": "超长射程",
    "Custom E-liter 4K Scope": "超长射程",
    "Custom Explosher": "长射程",
    "Douser Dualies FF": "中长射程",
    "Dread Wringer D": "中射程",
    "Foil Flingza Roller": "短中射程",
    "Glooga Dualies Deco": "中射程",
    "Nautilus 79": "中射程",
    "New Squiffer": "中长射程",
    "Recycled Brella 24 Mk I": "中射程",
    "Bamboozler 14 Mk II": "中长射程",
    "Charcoal Decavitator": "中射程",
    "Custom Douser Dualies FF": "中长射程",
    "Custom Hydra Splatling": "超长射程",
    "Custom Range Blaster": "中射程",
    "Custom Wellstring V": "长射程",
    "Heavy Edit Splatling Nouveau": "中射程",
    "Mint Decavitator": "中射程",
    "Recycled Brella 24 Mk II": "中射程",
    "Wellstring V": "长射程",
    "Splash-o-matic GCK-O": "短射程",
    "Colorz Aerospray": "短射程",
    "Glamorz Splattershot": "短射程",
    "Splattershot Pro FRZ-N": "中射程",
    "Clawz .96 Gal": "中射程",
    "Jet Squelcher COB-R": "长射程",
    "Gleamz Blaster": "短中射程",
    "Rapid Blaster Pro WNT-R": "中长射程",
    "Glitterz L-3 Nozzlenose": "短中射程",
    "H-3 Nozzlenose VIP-R": "中射程",
    "Carbon Roller ANG-L": "短射程",
    "Starz Dynamo Roller": "中长射程",
    "Planetz Big Swig Roller": "短中射程",
    "Cometz Octobrush": "短射程",
    "Painbrush BRN-Z": "短中射程",
    "Splat Charger CAM-O": "超长射程",
    "Splatterscope CAM-O": "超长射程",
    "Tri-Slosher ASH-N": "短射程",
    "Hornz Dread Wringer": "中射程",
    "Mini Splatling RTL-R": "中射程",
    "Torrentz Hydra Splatling": "超长射程",
    "Dapple Dualies NOC-T": "短射程",
    "Twinklez Splat Dualies": "短射程",
    "Hoofz Dualie Squelchers": "中射程",
    "Tenta Brella CRE-M": "中射程",
    "Patternz Undercover Brella": "短射程",
    "Bulbz Tri-Stringer": "超长射程",
    "REEF-LUX 450 MIL-K": "短中射程",
    "Stickerz Splatana Stamper": "中射程",
    "Splatana Wiper RUS-T": "短中射程",
}
